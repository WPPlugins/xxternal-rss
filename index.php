...
Plugin URI: http://www.pretzlaff.info/wp/wordpress-plugins/xxternal-rss
...
Version: 0.1.12
Author: Ruediger Pretzlaff
Author URI: http://www.pretzlaff.info
*/
# if(preg_match('#' . basename(__FILE__) . '#', $_SERVER['PHP_SELF'])) { die('You are not allowed to call this page directly.'); }

define('externalrssversion',  "0.1.12");
define('externalrssauthor',   "Ruediger Pretzlaff");
define('externalrssemail',    "ruediger@pretzlaff.info");
define('externalrssurl',      "http://www.pretzlaff.info/wp/wordpress-plugins/xxternal-rss/");
define('externalrssdate',     "Mi  2 Feb 2011 00:08:14 CET");
define('externalrssbuild',    "#136");
